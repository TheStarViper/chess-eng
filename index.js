...
// include: C:\Users\andre\AppData\Local\Temp\tmpftfd3tpa.js
...
// end include: C:\Users\andre\AppData\Local\Temp\tmpftfd3tpa.js
// include: C:\Users\andre\AppData\Local\Temp\tmpnsro4our.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\andre\AppData\Local\Temp\tmpnsro4our.js
// include: C:\Users\andre\AppData\Local\Temp\tmph0jqsdk_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\andre\AppData\Local\Temp\tmph0jqsdk_.js
...
var ASM_CONSTS = {
  148160: () => { if (document.fullscreenElement) return 1; },  
 148206: () => { return document.getElementById('canvas').width; },  
 148258: () => { return parseInt(document.getElementById('canvas').style.width); },  
 148326: () => { document.exitFullscreen(); },  
 148353: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 148426: () => { if (document.fullscreenElement) return 1; },  
 148472: () => { return document.getElementById('canvas').width; },  
 148524: () => { return screen.width; },  
 148549: () => { document.exitFullscreen(); },  
 148576: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 148709: () => { return window.innerWidth; },  
 148735: () => { return window.innerHeight; },  
 148762: () => { if (document.fullscreenElement) return 1; },  
 148808: () => { return document.getElementById('canvas').width; },  
 148860: () => { return parseInt(document.getElementById('canvas').style.width); },  
 148928: () => { if (document.fullscreenElement) return 1; },  
 148974: () => { return document.getElementById('canvas').width; },  
 149026: () => { return screen.width; },  
 ...
 156148: ($0) => { miniaudio.untrack_device_by_index($0); },  
 156191: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 156316: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
